...
%buckconverter.Efficiency = 0.9; %too hard to impliment
...
fuelcell.CellOCVoltage = 1.02-2/28;%1.02; %open circuit voltage
...
if 1
    ...
    car.plot_Drag(track.AirDensity,savef)
